const translations = {
    'pt-BR': {
        ...
        'career-mobile-desc': 'Experiência em desenvolvimento de aplicativos Android nativos com Java e aplicações multiplataforma com Flutter, criando soluções móveis inovadoras e eficientes.',
        ...
        'career-devops-desc': 'Experiência com servidor de aplicação Weblogic, integração contínua com Jenkins, controle de versão com Git e desenvolvimento de integrações com órgãos fiscais.',
        ...
        'project-1-desc': 'Sistema completo de gestão empresarial com integrações fiscais e módulos personalizáveis para diferentes setores.',
        'project-2-title': 'App de Delivery',
        'project-2-desc': 'Aplicativo mobile para entrega de produtos com rastreamento em tempo real e sistema de avaliação.',
        'project-3-title': 'E-commerce Platform',
        'project-3-desc': 'Plataforma completa de e-commerce com sistema de pagamentos, gestão de estoque e analytics.',
        'project-4-title': 'Sistema de BI',
        'project-4-desc': 'Dashboard interativo para análise de dados empresariais com geração de relatórios automatizados.',
        'project-5-title': 'App de Finanças',
        'project-5-desc': 'Aplicativo para controle financeiro pessoal com análise de gastos e planejamento orçamentário.',
        'project-6-title': 'CRM Inteligente',
        'project-6-desc': 'Sistema de gestão de relacionamento com cliente utilizando IA para previsão de vendas.',
        'project-7-title': 'Plataforma de Ensino',
        'project-7-desc': 'Sistema de educação à distância com suporte a aulas ao vivo, exercícios interativos e análise de desempenho.',
        'project-8-title': 'App de Saúde',
        ...
        'project-9-title': 'Sistema IoT Industrial',
        'project-9-desc': 'Plataforma de monitoramento em tempo real para equipamentos industriais com alertas preditivos.',
    ...
    'en': {
        ...
        'career-mobile-desc': 'Experience in native Android app development with Java and cross-platform applications with Flutter, creating innovative and efficient mobile solutions.',
        ...
        'career-devops-desc': 'Experience with Weblogic application server, continuous integration with Jenkins, version control with Git and development of integrations with tax authorities.',
        ...
        'project-1-desc': 'Complete enterprise management system with tax integrations and customizable modules for different sectors.',
        'project-2-title': 'Delivery App',
        'project-2-desc': 'Mobile application for product delivery with real-time tracking and rating system.',
        'project-3-title': 'E-commerce Platform',
        'project-3-desc': 'Complete e-commerce platform with payment system, inventory management and analytics.',
        'project-4-title': 'BI System',
        'project-4-desc': 'Interactive dashboard for business data analysis with automated report generation.',
        'project-5-title': 'Finance App',
        'project-5-desc': 'Application for personal financial control with expense analysis and budget planning.',
        'project-6-title': 'Smart CRM',
        'project-6-desc': 'Customer relationship management system using AI for sales forecasting.',
        'project-7-title': 'Learning Platform',
        'project-7-desc': 'Distance education system with support for live classes, interactive exercises and performance analysis.',
        ...
        'project-9-desc': 'Real-time monitoring platform for industrial equipment with predictive alerts.',
